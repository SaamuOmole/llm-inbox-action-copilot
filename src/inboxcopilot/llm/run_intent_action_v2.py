...
PROMPT_PATH = Path("src/inboxcopilot/llm/prompts/intent_action_v2.txt")
GOLD_PATH = Path("data/gold/gold_labeled.jsonl")
PROC_PATH = Path("data/processed/emails_weak_labeled.jsonl")
OUT_PATH = Path("data/predictions/intent_action_v2.jsonl")
        ...
        for email_id, gold in gold_idx.items():
            ...
            try:
                ...
                out = {
                    ...
                    "prompt_version": "intent_action_v2",
                }
